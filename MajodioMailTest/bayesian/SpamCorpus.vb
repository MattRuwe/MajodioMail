...
'    'Constants
'    Private Const TOKEN_SEPERATOR_REGEX As String = "(?i)(?:\"".{1," & MAX_TOKEN_LENGTH_STRING & "}?\"")|(?:\<.{1," & MAX_TOKEN_LENGTH_STRING & "}?\>)|(?:\{.{1," & MAX_TOKEN_LENGTH_STRING & "}?\})|(?:\[.{1," & MAX_TOKEN_LENGTH_STRING & "}?\])|(?:\<.{1," & MAX_TOKEN_LENGTH_STRING & "}?\>)|(?:[a-z0-9\-'\$]+)" '"(?i)[a-z0-9\-'\$]+"
...
'        'If rVal < MINIMUM_PROBABILITY Then
'        '    rVal = MINIMUM_PROBABILITY
'        'ElseIf rVal > MAXIMUM_PROBABILITY Then
'        '    rVal = MAXIMUM_PROBABILITY
'        'End If
'        Return rVal
'    End Function
...
'        If rVal < MINIMUM_MESSAGE_PROBABILITY Then
